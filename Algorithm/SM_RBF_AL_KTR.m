...
% [x_best,fval_best,NFE,output] = optimalRBFALKTR...
%     (model_function,variable_number,low_bou,up_bou,...
...
save([benchmark_name,'_RBF_AL_KTR','.mat']);

%% main
function [x_best,fval_best,NFE,output] = optimalRBFALKTR...
    (model_function,variable_number,low_bou,up_bou,...
    cheapcon_function,....

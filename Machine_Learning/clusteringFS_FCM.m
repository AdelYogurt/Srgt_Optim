...
X = [rand(x_number,variable_number)*0.5;0.5+rand(x_number,variable_number)];
[center_list,FC_model] = clusteringFuzzyFeatureSpace(X,classify_number,m);
clusteringVisualization(FC_model);
